...
class DatabaseImpl {
 ...
 public:
  DatabaseImpl(const string &databasePath, const string &backupPath,
               bool debug);
  ~DatabaseImpl();
  ...
  grpc::Status CreateDatabase(Metadata *metadata,
                              const propane::PropaneDatabaseRequest *request,
                              propane::PropaneStatus *reply);
  grpc::Status UpdateDatabase(Metadata *metadata,
                              const propane::PropaneDatabaseRequest *request,
                              propane::PropaneStatus *reply);
  grpc::Status DeleteDatabase(Metadata *metadata,
                              const propane::PropaneDatabaseRequest *request,
                              propane::PropaneStatus *reply);

  grpc::Status Backup(Metadata *metadata, const string &databaseName,
                      const string &zipFilePath);
  grpc::Status Restore(Metadata *metadata, const string &databaseName,
                       const string &zipFilePath);
};